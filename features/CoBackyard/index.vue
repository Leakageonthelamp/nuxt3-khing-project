<template>
  <div class="co-backyard-page">
    ...
    <div class="homepage-body px-4 md:px-20 pt-6 md:pt-14 pb-8 md:pb-16">
      ...
      <div class="w-full flex items-center justify-center mt-10 md:mt-20 mb-8 md:mb-10">
        <p class="text-sm">
    ...
    <div
      ...
      :key="`${list.id}-${index}`"
      class="fixed bottom-10 left-4 md:bottom-16 md:left-24"
    >
