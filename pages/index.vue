  ...
  <div class="main-container">
    <div class="heading">
      ...
      <p class="heading__credits">
        ...
        time with the following amazing modules:
      </p>
    </div>
    <div class="cards">
      <div class="card prisma__card">
        <div class="card__body">
          ...
          <p>
            Prisma unlocks a new level of developer experience when working with databases thanks to
            its intuitive data model, automated migrations, type-safety & auto-completion.
          </p>
        </div>
      ...
      <div class="card auth__card">
        <div class="card__body">
          ...
          <p>
            Nuxt user authentication and sessions through nuxt-auth. nuxt-auth wraps NextAuth.js to
            offer the reliability & convenience of a 12k star library to the nuxt 3 ecosystem with a
            native developer experience (DX)
          </p>
        </div>
        <p class="card__action">
          <a
          ...
          <a class="card__link" href="/protected" target="_blank"> See example </a>
        </p>
      </div>
