<template>
  <div class="border-b border-black pt-60">
    <nuxt-img src="/images/homepage/comp.gif" class="w-full" alt="section1" />

    <div class="mt-24 mb-10">
      <div class="text-2xl leading-normal font-poppins">
        ...
        refining my ideas based on user feedback, leading to products that are both functional<br />
